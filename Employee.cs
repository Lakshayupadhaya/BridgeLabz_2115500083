...
{   //Initialize variables
    private static string CompanyName = "Capgemini Company";
    private string Name;
...
class Program
{
    static void Main(string[] args)
    {
        ...
        Employee emp1 = new Employee(123, "Lakshay", "SoftWare Engineer");
        Employee emp2 = new Employee(011, "Prachi", "Manager");
