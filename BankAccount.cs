...
class BankAccount{
    ...
    private readonly long accountNumber;//Can only be assigned one time after no alteration
...
class Program{
    static void Main(string[] args){
        BankAccount acc1= new BankAccount("Lakshay",101);
        BankAccount acc2= new BankAccount("Pallavi",103);
